...
$query = "INSERT INTO HollandISO VALUES (".$queryChunk.");";
...
//echo $queryChunk;
$query = "INSERT INTO HollandScoring VALUES (".$queryChunk.");";
$result = mysql_query($query) or die('Query failed: ' . mysql_error());
mysql_free_result($result);
...
echo "document.body.innerHTML += '<form id=\"form\" action=\"http://tidepool.co/Live/IM5/IM5.php\" method=\"post\"><input type=\"hidden\" name=\"ID\" value=\"$ID\"/><input type=\"hidden\" name=\"password\" value=\"d3mo\"/>';";
