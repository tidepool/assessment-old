...
echo "document.body.innerHTML += '<form id=\"form\" action=\"http://tidepool.co/Live/Personality/Personality.php\" method=\"post\"><input type=\"hidden\" name=\"ID\" value=\"$ID\"/><input type=\"hidden\" name=\"password\" value=\"d3mo\"/>';";
