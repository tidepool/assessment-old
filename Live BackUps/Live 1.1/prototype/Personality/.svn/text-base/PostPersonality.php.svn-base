...
foreach($xml_array as $values)
{
	...
	function UploadScores()
	{
		...
		//echo "<h2>Your Work Type is: $workType</h2>";
...
echo "document.body.innerHTML += '<form id=\"form\" action=\"http://tidepool.co/Live/IM6/IM6.php\" method=\"post\"><input type=\"hidden\" name=\"ID\" value=\"$ID\"/><input type=\"hidden\" name=\"password\" value=\"d3mo\"/>';";
