...
echo "document.body.innerHTML += '<form id=\"form\" action=\"http://tidepool.co/Live/IM1/IM1.php\" method=\"post\"><input type=\"hidden\" name=\"ID\" value=\"$ID\"/><input type=\"hidden\" name=\"password\" value=\"d3mo\"/>';";
