...
echo "document.body.innerHTML += '<form id=\"form\" action=\"../Personality/Personality.php\" method=\"post\"><input type=\"hidden\" name=\"ID\" value=\"$ID\"/><input type=\"hidden\" name=\"password\" value=\"d3mo\"/>';";
