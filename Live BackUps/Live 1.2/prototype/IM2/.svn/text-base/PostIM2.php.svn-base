...
echo "document.body.innerHTML += '<form id=\"form\" action=\"../Balloon/Balloon.php\" method=\"post\"><input type=\"hidden\" name=\"ID\" value=\"$ID\"/><input type=\"hidden\" name=\"password\" value=\"d3mo\"/>';";
