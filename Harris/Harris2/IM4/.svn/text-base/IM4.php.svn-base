...
{
    $target = do_post_request("http://tidepool.co/Harris2/Map.php", "name=IM4");
    $loaders = do_post_request("http://tidepool.co/Harris2/LoadMap.php", "name=IM4");
...
<div align="center">
    ...
    ?>
        ...
        <embed src="IM4.swf?<? echo rand(1000000,9999999);?>" quality="high"
               width="96%" height="96%" scale="default" name="IM4" align="middle"
