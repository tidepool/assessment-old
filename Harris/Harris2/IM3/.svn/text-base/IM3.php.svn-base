...
{
    $target = do_post_request("http://tidepool.co/Harris2/Map.php", "name=IM3");
    $loaders = do_post_request("http://tidepool.co/Harris2/LoadMap.php", "name=IM3");
...
<div align="center">
    ...
    ?>
        ...
        <embed src="IM3.swf?<? echo rand(1000000,9999999);?>" quality="high"
               width="96%" height="96%" scale="default" name="IM3" align="middle"
