...
{
    $target = do_post_request("http://tidepool.co/Harris2/Map.php", "name=IM2");
    $loaders = do_post_request("http://tidepool.co/Harris2/LoadMap.php", "name=IM2");
...
<div align="center">
    ...
    ?>
        ...
        <embed src="IM2.swf?<? echo rand(1000000,9999999);?>" quality="high"
               width="96%" height="96%" scale="default" name="IM2" align="middle"
