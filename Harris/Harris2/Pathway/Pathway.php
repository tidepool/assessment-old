...
{
    $target = do_post_request("http://tidepool.co/Harris2/Map.php", "name=Pathway");
    $loaders = do_post_request("http://tidepool.co/Harris2/LoadMap.php", "name=Pathway");
...
<div align="center">
    ...
    ?>
        ...
        <embed src="Pathway.swf?<? echo rand(1000000,9999999);?>" quality="high"
               width="96%" height="96%" scale="default" name="Pathway" align="middle"
