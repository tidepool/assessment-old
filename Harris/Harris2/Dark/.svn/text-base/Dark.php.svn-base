...
{
    $target = do_post_request("http://tidepool.co/Harris2/Map.php", "name=Dark");
    $loaders = do_post_request("http://tidepool.co/Harris2/LoadMap.php", "name=Dark");
...
<div align="center">
    ...
    ?>
        ...
        <embed src="Dark.swf?<? echo rand(1000000,9999999);?>" quality="high"
               width="96%" height="96%" scale="default" name="Dark" align="middle"
