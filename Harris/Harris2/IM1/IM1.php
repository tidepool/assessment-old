...
{
    $target = do_post_request("http://tidepool.co/Harris2/Map.php", "name=IM1");
    $loaders = do_post_request("http://tidepool.co/Harris2/LoadMap.php", "name=IM1");
...
<div align="center">
    ...
    ?>
        ...
        <embed src="IM1.swf?<? echo rand(1000000,9999999);?>" quality="high"
               width="96%" height="96%" scale="default" name="IM1" align="middle"
