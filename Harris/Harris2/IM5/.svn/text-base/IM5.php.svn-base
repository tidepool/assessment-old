...
{
    $target = do_post_request("http://tidepool.co/Harris2/Map.php", "name=IM5");
    $loaders = do_post_request("http://tidepool.co/Harris2/LoadMap.php", "name=IM5");
...
<div align="center">
    ...
    ?>
        ...
        <embed src="IM5.swf?<? echo rand(1000000,9999999);?>" quality="high"
               width="96%" height="96%" scale="default" name="IM5" align="middle"
