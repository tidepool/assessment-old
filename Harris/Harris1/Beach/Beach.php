...
{
    $target = do_post_request("http://tidepool.co/Harris1/Map.php", "name=Beach");
    $loaders = do_post_request("http://tidepool.co/Harris1/LoadMap.php", "name=Beach");
...
<div align="center">
    ...
    ?>
        ...
        <embed src="Beach.swf?<? echo rand(1000000,9999999);?>" quality="high"
               width="96%" height="96%" scale="default" name="Beach" align="middle"
