...
{
    $target = do_post_request("http://tidepool.co/Harris1/Map.php", "name=Space");
    $loaders = do_post_request("http://tidepool.co/Harris1/LoadMap.php", "name=Space");
...
<div align="center">
    ...
    ?>
        ...
        <embed src="Space.swf?<? echo rand(1000000,9999999);?>" quality="high"
               width="96%" height="96%" scale="default" name="Space" align="middle"
