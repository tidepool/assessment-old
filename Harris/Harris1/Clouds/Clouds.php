...
{
    $target = do_post_request("http://tidepool.co/Harris1/Map.php", "name=Clouds");
    $loaders = do_post_request("http://tidepool.co/Harris1/LoadMap.php", "name=Clouds");
...
<div align="center">
    ...
    ?>
        ...
        <embed src="Clouds.swf?<? echo rand(1000000,9999999);?>" quality="high"
               width="96%" height="96%" scale="default" name="Clouds" align="middle"
