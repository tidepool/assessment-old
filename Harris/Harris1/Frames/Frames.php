...
{
    $target = do_post_request("http://tidepool.co/Harris1/Map.php", "name=Frames");
    $loaders = do_post_request("http://tidepool.co/Harris1/LoadMap.php", "name=Frames");
...
<div align="center">
    ...
    ?>
        ...
        <embed src="Frames.swf?<? echo rand(1000000,9999999);?>" quality="high"
               width="96%" height="96%" scale="default" name="Frames" align="middle"
