...
<script language="JavaScript">
    document.body.innerHTML += '<form id="form" action="https://www.tidepool.co/Delta/Loading/Loading.php?stage=0" method="post">';
...
else
{
    ...
    $query = "SELECT COUNT(user_id) FROM delta_users;";
    ...
    $date = date("m-j-y");
    $query = "INSERT INTO delta_users VALUES ('$ID', '$date','', '$IP','$browser',now());";
...
<head>
    ...
    <script language="JavaScript">
        function sendToJavaScript(value) {
            ...
            //alert(value);
            //document.getElementById("form").submit();
            window.location.replace("../<? echo $loaders."/".$loaders?>.php");
        }
