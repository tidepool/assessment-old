package
{
	...
	public class PlacesSlider extends MovieClip
	{
		...
		private var screen:PlacesSliderScreen;
		
		public function PlacesSlider(p_main:Main, p_x:Number, p_y:Number, p_length:Number, left:String, right:String, scr:PlacesSliderScreen)
		{
			//241
			main = p_main;
			length = p_length;
		...
		public function onLoaderReady(e:Event):void
		{
			...
			sprite.x = positionX + length / 2 - myLoader.width / 2 + 5;
			//reset();
