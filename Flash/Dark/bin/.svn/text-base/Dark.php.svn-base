...
{
    $target = do_post_request("http://tidepool.co".$foldername."/Map.php", "name=Dark");
    $loaders = do_post_request("http://tidepool.co".$foldername."/LoadMap.php", "name=Dark");
...
<head>
    ...
    <script language="JavaScript">
        ...
        function sendToAS3() {
            var flash = getFlashMovieObject("Dark");
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
        id="Dark" width="100%" height="100%"
        codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab">
    <param name="movie" value="Dark.swf" />
    <param name="quality" value="high" />
    <param name="bgcolor" value="#869ca7" />
    <param name="scale" value="exactfit">
    <param name="allowScriptAccess" value="default" />
    <embed src="Dark.swf?<? echo rand(1000000,9999999);?>" quality="high"
           width="100%" height="100%" scale="default" name="Dark" align="middle"
