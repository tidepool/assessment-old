package
{
	...
	public class Slider extends MovieClip
	{
		...
		public function Slider(p_main:Main, p_x:Number, p_y:Number, p_length:Number, left:String, right:String)
		{
			...
			textRight.textColor = 0xFFFFFF;
			
			textLeft.text = left;
			textLeft.selectable = false;
			textLeft.setTextFormat(format1);
			textLeft.textColor = 0xFFFFFF;
		...
		public function onLoaderReady(e:Event):void
		{
			...
			textLeft.y = positionY + 75;
			textRight.x = positionX + length-25;
			textRight.y = positionY + 75;
		...
		public function drawMarker(e:Event):void
		{
			...
			barSprite.graphics.drawRect(0, 20, 1, 20);
			barSprite.graphics.drawRect(len - 1, 20, 1, 20);
			barSprite.graphics.drawRect(len / 2, 20, 1, 20);
			barSprite.graphics.drawRect(len / 4, 20, 1, 15);
			barSprite.graphics.drawRect(len / 4 * 3, 20, 1, 15);
