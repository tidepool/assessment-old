...
{
    $target = do_post_request("http://tidepool.co".$foldername."/Map.php", "name=Space");
    $loaders = do_post_request("http://tidepool.co".$foldername."/LoadMap.php", "name=Space");
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
    ...
    <embed src="Space.swf?<? echo rand(1000000,9999999);?>" quality="high"
           width="100%" height="100%" SCALE="exactfit" name="Space" align="middle"
