package
{
	...
	public class Balloon
	{
		...
		public function Balloon(p_main:Main, p_x:Number, p_y:Number, ind:int, picStr:String, textString:String = "")
		{
			...
			balloonString = new Picture(main, positionX - 5, positionY + 200, "assets/Balloon_String.png", initialScale * scale);
			
			balloon = new Picture(main, positionX, positionY, "assets/Balloon_" + getSuffix(ind) + ".png", initialScale * scale);
			pic = new Picture(main, positionX, positionY-20, "assets/" + ind + ".jpg", 150 * scale);
		...
		public function update():void
		{
			...
			balloonString.positionY = positionY + (245 * scale);
		}
