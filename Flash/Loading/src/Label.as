package  
{
	...
	{
		[Embed(source="Lato-Regular.ttf",fontName="myFont",mimeType="application/x-font",fontWeight="normal",fontStyle="normal",advancedAntiAliasing="true",embedAsCFF="false")]
		...
		public function Label(p_main:Main,p_x:Number,p_y:Number,p_s:String,size:int=25,p_w:Number=800)
		{
			...
			var format1:TextFormat  = new TextFormat("myFont");
			format1.size = size;
