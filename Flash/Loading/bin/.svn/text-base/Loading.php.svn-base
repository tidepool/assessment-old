...
<script language="JavaScript">
    document.body.innerHTML += '<form id="form" action="http://www.tidepool.co/Delta/Loading/Loading.php" method="post">';
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
    ...
    <embed src="Loading.swf?<? echo rand(1000000,9999999);?>" quality="high"
           width="100%" height="100%" scale="default" name="Loading" align="middle"
