package  
{
	...
	public class pictureDecoration extends MovieClip 
	{
		...
		public var shouldAdd:Boolean = false;
		
		
		public function pictureDecoration(p_main:Main,p_x:Number,p_y:Number,s:String,p_length:Number) 
		{
			main = p_main;
			positionX = p_x;
			positionY = p_y;
