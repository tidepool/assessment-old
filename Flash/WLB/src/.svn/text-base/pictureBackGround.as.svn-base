package  
{
	...
	public class pictureBackGround extends MovieClip 
	{
		...
		public function pictureBackGround(p_main:Main,p_x:Number,p_y:Number,s:String,p_length:Number,p_chart:piechart=null) 
		{
			main = p_main;
			chart = p_chart;
			positionX = p_x;
