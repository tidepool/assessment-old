package  
{
	 ...
	 * @author wei
	 */
	public class TechMessage1 extends MovieClip 
	{
		...
		public function TechMessage1(p_main:Main,p_x:Number,p_y:Number,s:String) 
		{
			main = p_main;
			positionX = p_x;
			positionY = p_y;
		...
		public function update(e:Event=null):void
		{
			...
			header2.y = 240 + positionY+20;
			header1.x = 450 + positionX;
			header1.y = 240 + positionY+20;
			myLoader.x = positionX;
			myLoader.y = positionY+20;
		}
	}
