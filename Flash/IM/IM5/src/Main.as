package 
{
	...
	public class Main extends Sprite 
	{
		...
		public function run():void
		{
			...
			button1 = new ResponseButton(this,397,651,"Please stop interrupting me",1);			
			
			button2 = new ResponseButton(this, 595, 651, "I don’t know you, but I feel better knowing I’m not alone!", 2, 20);
			
			button3 = new ResponseButton(this, 793, 651, "I really didn’t notice you were gone",3);
			
			button4 = new ResponseButton(this,992,651,"I’d love to talk about this test with you or someone else when I finish",4,20);
			
			techMessage = new TechMessage(this,0,200,"I’m back. Did you miss me?");
		...
		public function newMessage1():void
		{
			...
			new TechMessage1(this,0,240,"Don’t forget the “T” for questions or emergencies.");
			instructions.text.text = "";
		...
		public function postData():void
		{
			...
			var xmlURLReq:URLRequest = new URLRequest("http://www.tidepool.co/Posts/PostIM5.php");				
