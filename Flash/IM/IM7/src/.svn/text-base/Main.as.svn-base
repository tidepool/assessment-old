package 
{
	...
	public class Main extends Sprite 
	{
		...
		public function run():void
		{
			...
			button1 = new ResponseButton(this,397,651,"Thank you! I’ve enjoyed this.",1);			
			
			button2 = new ResponseButton(this, 595, 651,"You’ve really done nothing to help me.",2);
			
			button3 = new ResponseButton(this, 793, 651, "Do you think I did alright?",3);
			
			button4 = new ResponseButton(this,992,651,"Don’t contact me anymore.",4);
			
			techMessage = new TechMessage(this,0,200,"You’re almost done! Great job!");
		...
		public function postData():void
		{
			...
			var xmlURLReq:URLRequest = new URLRequest("http://www.tidepool.co/Posts/PostIM7.php");				
