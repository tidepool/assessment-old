package 
{
	...
	public class Main extends Sprite 
	{
		...
		public function run():void
		{
			...
			button1 = new ResponseButton(this,397,651,"Yup. I’d rather not chat right now",1);			
			
			button2 = new ResponseButton(this, 595, 651,"Yes! Who are you?",2);
			
			button3 = new ResponseButton(this, 793, 651, "(no response)",3);
			
			button4 = new ResponseButton(this,992,651,"It was cool. This is fun!",4);
			
			techMessage = new TechMessage(this,0,200,"That one was pretty cool, huh?");
		...
		public function newMessage1():void
		{
			...
			new TechMessage1(this,0,240,"I’ll be back, but remember to press “T” if you need help in the meantime.");
			instructions.text.text = "";
		...
		public function postData():void
		{
			...
			var xmlURLReq:URLRequest = new URLRequest("http://www.tidepool.co/Posts/PostIM2.php");				
