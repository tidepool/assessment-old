package 
{
	...
	public class Main extends Sprite 
	{
		...
		public function run():void
		{
			...
			button1 = new ResponseButton(this,397,651,"Fine",1);			
			
			button2 = new ResponseButton(this, 595, 651,"All is well. But if I need you I’ll press “T”",2);
			
			button3 = new ResponseButton(this, 793, 651, "These messages are a bit disruptive",3);
			
			button4 = new ResponseButton(this,992,651,"I’d really like to know who this is",4);
			
			techMessage = new TechMessage(this,0,200,"Just checking to see if everything is okay. How’s it going?");
		...
		public function postData():void
		{
			...
			var xmlURLReq:URLRequest = new URLRequest("http://www.tidepool.co//Posts/PostIM3.php");				
