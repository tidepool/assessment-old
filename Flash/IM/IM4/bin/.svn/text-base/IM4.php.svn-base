...
{
    $target = do_post_request("http://tidepool.co".$foldername."/Map.php", "name=IM4");
    $loaders = do_post_request("http://tidepool.co".$foldername."/LoadMap.php", "name=IM4");
...
<head>
    ...
    <script language="JavaScript">
        ...
        function sendToAS3() {
            var flash = getFlashMovieObject("IM4");
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
        id="IM4" width="100%" height="100%"
        codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab">
    <param name="movie" value="IM4.swf" />
    <param name="quality" value="high" />
    <param name="bgcolor" value="#869ca7" />
    <param name="scale" value="default">
    <param name="allowScriptAccess" value="sameDomain" />
    <embed src="IM4.swf?<? echo rand(1000000,9999999);?>" quality="high"
           width="100%" height="100%" scale="default" name="IM4" align="middle"
