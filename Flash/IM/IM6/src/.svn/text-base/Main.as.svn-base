package 
{
	...
	public class Main extends Sprite 
	{
		...
		public function run():void
		{
			...
			button1 = new ResponseButton(this,397,651,"Oops, sorry. Just tell me what I can do.",1);			
			
			button2 = new ResponseButton(this, 595, 651, "Any errors are probably due to your lack of guidance.", 2, 20);
			
			button3 = new ResponseButton(this, 793, 651, "I’ve done everything you’ve asked.",3);
			
			button4 = new ResponseButton(this,992,651,"Please fix it and stop bothering me.",4);
			
			techMessage = new TechMessage(this,0,200,"Hold on for a minute - there’s a chance you made a mistake.");
		...
		public function postData():void
		{
			...
			var xmlURLReq:URLRequest = new URLRequest("http://www.tidepool.co/Posts/PostIM6.php");					
