...
{
    $target = do_post_request("http://tidepool.co".$foldername."/Map.php", "name=IM1");
    $loaders = do_post_request("http://tidepool.co".$foldername."/LoadMap.php", "name=IM1");
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
    ...
    <embed src="IM1.swf?<? echo rand(1000000,9999999);?>" quality="high"
           width="100%" height="100%" scale="default" name="IM1" align="middle"
