package  
{
	...
	public class CheckButton 
	{
		...
		public var buttons:CheckButtons;
		public var name:String;
		public function CheckButton(p_main:Main,p_buttons:CheckButtons,px:Number,py:Number,p_name:String="") 
		{
			main = p_main;
			name = p_name;
			buttons = p_buttons;
			positionX = px;
			positionY = py;
			pic1 = new picture(main, px, py, "assets/circle1.png", 15);
			pic2 = new picture(main, px, py, "assets/circle.png", 15);
