package  
{
	...
	public class picture extends MovieClip 
	{
		...
		public var defaultIndex:int = 10;
		
		
		public function picture(p_main:Main,p_x:Number,p_y:Number,s:String,p_length:Number,p_defaultIndex:int=10) 
		{
			main = p_main;
			positionX = p_x;
			positionY = p_y;
		...
		public function onLoaderReady(e:Event) :void
		{
			...
			if (main.contains(sprite))
			{
				if (defaultIndex < 5)
				{
					main.setChildIndex(sprite,defaultIndex);
				}
				else
				{
