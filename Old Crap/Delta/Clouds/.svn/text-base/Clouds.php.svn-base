...
if($ID != null)
{
    $target = do_post_request("http://tidepool.co/Delta/Map.php", "name=Clouds");
    ?>
<html lang="en">
<head>
...
<div align="center">
    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
        ...
        <embed src="Clouds.swf" quality="high"
               width="96%" height="96%" SCALE="exactfit" name="Clouds" align="middle"
