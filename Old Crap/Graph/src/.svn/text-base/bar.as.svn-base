package  
{
	...
	public class bar extends MovieClip 
	{
		...
		public function onLoaderReady(e:Event) :void
		{
			...
			barNameLabel=new label(main, positionX - 110, positionY + 7, barName);
			sprite.scaleX = 0;
		}
		
		public function drawBar(p_value:Number,p_max:Number):void
		{
			var fileRequest:URLRequest = new URLRequest("assets/Graph/bar.png");
		...
		public function update(e:Event=null):void
		{
			if (main.contains(sprite))
			{
				...
				{
					redrawTimer = 3;
					if ((scale-sprite.scaleX) / 20 < 0.01)
					{
						sprite.scaleX = sprite.scaleX + 0.01;
					}
					else if ((scale-sprite.scaleX) / 20 >0.06)
					{
						sprite.scaleX = sprite.scaleX + 0.06;
					}
					else
					{
					...
					text.changeText(px-13, positionY +7, 25, (int)(value * 100 * sprite.scaleX / scale) + "");
				}
