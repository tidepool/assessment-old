...
<div id="wrap">
    ...
    <div id="cont">
        ...
        <div class="post-assess-cont" style="margin-top: 50px;">
            ...
            <div class="txt-404">Flash not Detected</div>
            <div class="rl"></div>
            <div class="msg-flash" style="text-align: left;">Sorry, but our assessment requires <a href="http://www.adobe.com/software/flash/about/">Adobe Flash</a> to be installed on your device.  
			We're working on a version for iPad and iPhone, but for the now please visit our Web site on your Mac or PC to take the assessment.</div>
        </div>
